...
class Home {
        ...
        if (news) {
                ...
                blockNews.innerHTML = `
                    <div class="news-header">
                        ...
                        <div class="header-text">
                            <div class="title">Nenhuma notícia está disponível no momento.</div>
                        </div>
                        <div class="date">
                            <div class="day">1</div>
            ...
            blockNews.innerHTML = `
                <div class="news-header">
                    ...
                    <div class="news-content">
                        <div class="bbWrapper">
                            <p>Não foi possível entrar em contato com o servidor de notícias.</br>Por favor, verifique sua configuração.</p>
                        </div>
                    </div>`
            newsElement.appendChild(blockNews);
        }
    ...
    async startGame() {
        ...
        launch.on('progress', (progress, size) => {
            infoStarting.innerHTML = `Baixando ${((progress / size) * 100).toFixed(0)}%`
